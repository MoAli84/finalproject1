            ...
            <table class="table">
                ...
                <tbody>
                  <tr>
                    <td>Ahmed Ali </td>
                    <td>
                      <a href="show-profile.html" > <button type="button" class="btn btn-outline-primary"> Show Profile</button></a>    
                 </td>
                    <td><div>
                        <div class="w-50" >
                            <label for="exampleFormControlTextarea1" class="form-label" style="text-align: center;">Notes</label>
                  ...
                  <tr>
                    ...
                    <td><div>
                        <div class="w-50" >
                            <label for="exampleFormControlTextarea1" class="form-label" style="margin-right: 40px;">Notes</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" cols="50"></textarea>
                          </div>
                    </div></td>
